...
pub = rospy.Publisher('/hydrone_aerial_underwater0/command/trajectory', MultiDOFJointTrajectory, queue_size=10)
...
if __name__ == "__main__":
    rospy.init_node("mission_planner_node0", anonymous=False)

    rospy.Subscriber("/hydrone_aerial_underwater0/ground_truth/odometry", Odometry, position_callback)
    rospy.Subscriber("/hydrone_aerial_underwater0/cmd_vel", Twist, velocity_callback)
