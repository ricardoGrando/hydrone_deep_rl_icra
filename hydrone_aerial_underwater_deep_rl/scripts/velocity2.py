...
pub = rospy.Publisher('/hydrone_aerial_underwater2/command/trajectory', MultiDOFJointTrajectory, queue_size=10)
...
if __name__ == "__main__":
    rospy.init_node("mission_planner_node2", anonymous=False)

    rospy.Subscriber("/hydrone_aerial_underwater2/ground_truth/odometry", Odometry, position_callback)
    rospy.Subscriber("/hydrone_aerial_underwater2/cmd_vel", Twist, velocity_callback)
